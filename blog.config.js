...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || '小X', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '一些个体体验', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://notion-next-seven-sand-97.vercel.app', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || '风景,还活着,文艺作品吃播,同人,心情', // 网站关键词 英文逗号隔开
